        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="w-full lg:w-2/3">
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900">
              Dhamrai Drisiti Kalyan Eye Hospital — Redefining Everyday Style
            </h1>

            <p className="mt-4 text-gray-700 leading-relaxed policy-page-text">
              Dhamrai Drisiti Kalyan Eye Hospital is a modern e-commerce brand dedicated to delivering
            ...
            <p className="mt-6 text-gray-600">
              Driven by a passion for design and customer satisfaction, Dhamrai Drisiti Kalyan Eye Hospital
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                aria-label="Shop Dhamrai Drisiti Kalyan Eye Hospital collections"
              >
                Shop Collections
              </a>
              <a
                ...
                aria-label="Learn more about Dhamrai Drisiti Kalyan Eye Hospital"
              >
                Learn More
              </a>
            </div>
